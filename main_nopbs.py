...
if __name__ == '__main__':
    ...
    og = EmarketModel(s_supply          = .15,         #standard deviation of supply 
    ...
    S_bar_star      = brentq(G_star, .1, 150, xtol = tol_brent)
    ...
    pickle.dump(og, open("/scratch/kq62/{}.mod".format(modelname),"wb"))
    ...
    pickle.dump(og, open("/scratch/kq62/{}_endog.mod".format(modelname),"wb"))
