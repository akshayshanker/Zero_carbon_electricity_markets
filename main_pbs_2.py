...
if __name__ == '__main__':
    ...
    array = genfromtxt('array_2.csv', delimiter=',')[1:]      
    ...
    S_bar_star      = brentq(G_star, 1e-5, 100, xtol = tol_brent)
    ...
    pickle.dump(og, open("/scratch/kq62/array_2_{}.mod".format(sys.argv[1]),"wb"))
    ...
    pickle.dump(og, open("/scratch/kq62/array_2_{}_endog.mod".format(sys.argv[1]),"wb"))
